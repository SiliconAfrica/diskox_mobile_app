    ...
    <Box width="100%" backgroundColor="mainBackGroundColor" marginTop="l">
      ...
      >
        <Pressable
          ...
          style={{ width: "50%", flex: 0.49, height: 50 }}
        >
          <Box
            flex={1}
            height={50}
            ...
            borderRadius={10}
            borderColor={
              gender === "male" ? "primaryColor" : "secondaryBackGroundColor"
            }
            backgroundColor={
              gender === "male"
                ? isDark
          ...
          >
            ...
            <CustomText
              variant="body"
              marginLeft="m"
              color={gender === "male" ? "primaryColor" : "textColor"}
            >
              Man
            </CustomText>
          </Box>
        ...
        >
          <Box
            ...
            borderRadius={10}
            borderColor={
              gender === "female" ? "primaryColor" : "secondaryBackGroundColor"
            }
            backgroundColor={
              gender === "female"
                ? isDark
          ...
          >
            ...
            <CustomText
              variant="body"
              marginLeft="m"
              color={gender === "female" ? "primaryColor" : "textColor"}
            >
              Woman
            </CustomText>
          </Box>
