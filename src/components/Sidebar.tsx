  ...
  return (
    <Box flex={1} backgroundColor='secondaryBackGroundColor' marginTop='xl'>
        <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', paddingHorizontal: 20 }}>
            <Image source={isDarkMode ? require('../../assets/images/logo.png'):require('../../assets/images/logoB.png')} contentFit='contain' transition={1000} style={{ height: 60, width: 60 }} />
            <Feather name='x' size={25} color={theme.colors.textColor} onPress={() => navigation.toggleDrawer()} />
        </View>
        <ScrollView>
            ...
            <Box paddingHorizontal='m' borderTopWidth={1} borderBottomWidth={1} flexDirection='row' justifyContent='space-between' alignItems='center' height={60} style={{ borderColor: isDarkMode ? 'grey':'lightgrey'}}>
                <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                    <Ionicons name={isDarkMode ? 'moon' : 'sunny'} size={25} color={theme.colors.textColor} />
