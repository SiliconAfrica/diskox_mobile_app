...
const FeedCard = ({
  ...
  const vote = (poll_id: number) => {
    ...
    if (check) {
      if (getDate() < 1) {
        toast.show("Poll has ended you cannot vote anymore", {
          type: "warning",
        });
        return;
      }
  ...
  return (
    <Box
      width="100%"
      bg={isDarkMode ? "secondaryBackGroundColor" : "mainBackGroundColor"}
    ...
    >
              ...
              >
                ...
                {myId !== userId && (
                  <CustomButton
                    ...
                    color={
                      isDarkMode ? "black" : theme.colors.fadedButtonBgColor
                    }
            ...
            {myId !== userId && (
              <>
                <ArchiveAdd
                  ...
                  variant={post.is_bookmarked === 1 ? "Bold" : "Outline"}
                />
              </>
            )}
            <Feather
              ...
              style={{ marginLeft: 10 }}
              onPress={() => setAll({ activePost: post, showPostAction: true })}
            />
          </Box>
        )}
      </Box>
      ...
      {activePost.reposted_post.length > 0 && (
        <Box marginHorizontal="m">
              ...
              <>
                {showMoreTitle ? (
                  ...
                  <CustomText
                    variant="header"
                    fontSize={16}
                  >{`${post.repost_comment?.slice(0, 150)}...`}</CustomText>
                ) : (
                  <CustomText variant="header" fontSize={16}>
                    {post.repost_comment}
                  </CustomText>
          ...
          <RepostFeedCard
            post={activePost.reposted_post[0]}
            followLoading={follow.isLoading}
                  ...
                  {!upvote.isLoading && (
                    <>
                      ...
                      <CustomText
                        ...
                        marginLeft="s"
                        color={
                          post.has_upvoted !== 0 ? "primaryColor" : "textColor"
                        }
                      >
                        {post.upvotes_count > 0 && post.upvotes_count} Upvote
                      </CustomText>
                    </>
                  )}
                </Pressable>
                    ...
                    <>
                      {
                        ...
                        <ArrowBigDown
                          ...
                          fill={
                            post.has_downvoted === 0 ? "transparent" : "red"
                          }
                        />
                      }
                      {/* {post.has_downvoted !== 0 && (
