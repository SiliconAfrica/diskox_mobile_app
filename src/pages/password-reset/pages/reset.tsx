...
const Reset = () => {
  ...
  return renderForm(
    ...
    <Box flex={0.7}>
      <CustomTextInput name='otp' placeholder='OTP sent to email' label='OTP code' containerStyle={{ marginTop: 20 }}  />
    ...
    <Box flex={0.3} justifyContent='center'>
      <SubmitButton label='Reset Password' onSubmit={navigate} isLoading={isLoading} />
    </Box>
  </Box>
  )
}
