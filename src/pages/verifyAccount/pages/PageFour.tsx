...
const RecordVideoScreen = ({next}: {
    ...
    //const videoRef: Video = useRef<Video>(null)
    ...
    return (
        <Box flex={1} paddingTop='m'>
            ...
            <CustomText variant='body' marginTop='m' color='grey'>Preview your video before</CustomText>
            ...
            { video === null && (
                <>
                    ...
                    <Box width='100%' paddingTop='m' justifyContent='center' alignItems='center'>
                        ...
                        >
                            { isRecording ?  <CustomText style={{ color: 'red' }} variant='header' fontSize={16}>{timer}s</CustomText> : <CustomText color='primaryColor' variant='header' fontSize={16}>START RECORDING</CustomText>}
                        </Pressable>
                    </Box>
            ...
            { video !== null && (
                <>
                    ...
                    <Box width={'100%'} height={350}  borderRadius={15} borderWidth={1} backgroundColor={isDarkMode ? 'mainBackGroundColor' : 'black'} marginTop='m' overflow='hidden' >
                    ...
                    <Box width='100%' paddingTop='m' justifyContent='center' alignItems='center'>
                        <Pressable style={{
                            ...
                            alignItems: 'center'
                                   ...
                                   onPress={handleRecordVideo}
                        >
                            { isLoading ? <CustomText variant='header' fontSize={16} color='primaryColor'>Uploading Video</CustomText> : <CustomText color='primaryColor' variant='header' fontSize={16}>Ready for submission</CustomText> }

                            { !isLoading && <CustomText marginTop='l' color='primaryColor' variant='header' fontSize={16}>Start Again</CustomText> }
            ...
            <Box width={'100%'} flex={1} flexDirection='row' justifyContent='space-between' alignItems='center'>
                <BorderButton color={isDarkMode ? 'white':'grey'} width={100} borderColor='black' height={44} title='Go Back' onPress={() => next(3)} borderRadius={10} />
                <PrimaryButton width={100} height={44} title={video !== null ? 'Submit':'Record'} isLoading={isLoading} onPress={handleSubmit} borderRadius={10} />
            </Box>
        </Box>
    );
};
