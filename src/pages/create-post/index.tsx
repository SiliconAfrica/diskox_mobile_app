 ...
 const handleSubmit = React.useCallback(() => {
  ...
  return (
    <Box flex={1} backgroundColor='mainBackGroundColor'>
      ...
      {/* HEADER SECTTION */}
      <Box width={'100%'} height={100} flexDirection='row' alignItems='center' px='m' justifyContent='space-between'>

        <Box flexDirection='row' alignItems='center'>

          <Box width={40} height={40} borderRadius={20} borderColor='primaryColor'>
            <Image source={{ uri: `${IMAGE_BASE}${profile_image}` }} style={{ width: 40, height: 40, borderRadius: 20 }} />
          </Box>
          ...
          <Box marginLeft='m'>
            ...
            <Pressable onPress={() => setAll({ showVisibility: true })} style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', borderRadius: 30, backgroundColor: theme.colors.secondaryBackGroundColor,  padding: 2 }}>
              <Ionicons name='globe-outline' size={20} color={theme.colors.textColor} />
        ...
        <FadedButton title='Tag people' onPress={() => setShow(true)} height={40}  />
      ...
      <Box width={'100%'} height={100} flexDirection='row' borderTopWidth={2} borderTopColor='secondaryBackGroundColor' paddingHorizontal='m' alignItems='center'>
        <Pressable onPress={handleDocumentPicker} style={{ width: 40, height: 40, borderRadius: 20, backgroundColor: theme.colors.secondaryBackGroundColor, justifyContent: 'center', alignItems: 'center' }}>
          <Ionicons name='image-outline' size={25} color={theme.colors.textColor} />
        </Pressable>

        <Pressable onPress={handleDocumentPicker} style={{ width: 40, height: 40, borderRadius: 20, backgroundColor: theme.colors.secondaryBackGroundColor, justifyContent: 'center', alignItems: 'center', marginLeft: 20 }}>
          <Ionicons name='videocam-outline' size={25} color={theme.colors.textColor} />
        </Pressable>
      </Box>
