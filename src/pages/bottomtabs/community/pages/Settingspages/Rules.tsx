...
const Rules = () => {
    ...
    return (
        <Box flex={1} backgroundColor='mainBackGroundColor'>
            <SettingsHeader title='Rules' showSave handleArrowPressed={() => navigation.goBack()} rightItem={<CustomText variant='body' color='primaryColor' onPress={() => navigation.push('community-settings', { id: 23, type: COMMUNITY_SETTING_TYPE.ADD_RULE})}>Add Rule</CustomText>} />
            <Box flex={1}>
